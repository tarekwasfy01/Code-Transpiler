...
func validateUASTCallExecutionContract(u *UniversalASTDocument, _ UASTExecutionPrimitive) error {
	return validatePrimitivePayloads(u, fieldSet("callee", "arguments", "parameters", "receiver", "dispatch", "candidates"), relationSet("call.calls", "dispatch.resolves", "overload.candidate"))
}
